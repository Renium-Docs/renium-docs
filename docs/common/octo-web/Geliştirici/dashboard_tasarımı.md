...
*Geliştirici* modülü altında yer alan *Dashboard Tanımları* ekranı ile tanımladığınız dashboardları detaylı olarak görüntüleyebilir ve yönetebilirsiniz. Bu ekranda;
- Yeni dashboarlar oluşturabilir,
- Daha önce oluşturduğunuz dashboardları düzenleyebilir,
- İhtiyaç kalmadığında dasboardlarınızı silebilirsiniz.
...
Dashboardda göstermek istediğiniz verileri, ilgili tablolardan **SQL sorguları** aracılığıyla *Dashboard Tasarlayıcısına* dahil etmeniz gerekmektedir.  
...
5. Açılan **Query Builder** ekranında, sağ tarafta yer alan **View** ve **Table** listelerinden dashboardunuza dahil etmek istediğiniz alanları seçiniz.  
